...
const I18N = {
  pt: {
    ...
    'tasks.confirmDelete':'Excluir \"{title}\"?', 'tasks.deleted':'\u2705 Tarefa exclu\u00EDda', 'tasks.checklist':'Checklist', 'tasks.addItem':'+ Adicionar',
    'tasks.client':'Cliente', 'tasks.status':'Status', 'tasks.personalNoClient':'Pessoal (sem cliente)', 'tasks.changeStatus':'Trocar status',
    'tasks.priorityHigh':'Alta', 'tasks.priorityNormal':'Normal', 'tasks.priorityLow':'Baixa',
    'tasks.statusOpen':'Em Aberto', 'tasks.statusInProgress':'Em Produ\u00E7\u00E3o', 'tasks.statusDone':'Conclu\u00EDda',
    'notif.taskAssignedTitle':'Voc\u00EA foi designado(a) numa tarefa', 'notif.taskAssignedBody':'{name} te atribuiu \u00E0 tarefa \"{task}\"', 'notif.viewTask':'Ver tarefa',
  ...
  en: {
    ...
    'tasks.confirmDelete':'Delete \"{title}\"?', 'tasks.deleted':'\u2705 Task deleted', 'tasks.checklist':'Checklist', 'tasks.addItem':'+ Add',
    'tasks.client':'Client', 'tasks.status':'Status', 'tasks.personalNoClient':'Personal (no client)', 'tasks.changeStatus':'Change status',
    'tasks.priorityHigh':'High', 'tasks.priorityNormal':'Normal', 'tasks.priorityLow':'Low',
    'tasks.statusOpen':'Open', 'tasks.statusInProgress':'In Progress', 'tasks.statusDone':'Done',
    'notif.taskAssignedTitle':'You\u2019ve been assigned a task', 'notif.taskAssignedBody':'{name} assigned you to the task \"{task}\"', 'notif.viewTask':'View task',
  ...
  es: {
    ...
    'tasks.confirmDelete':'\u00BFEliminar \"{title}\"?', 'tasks.deleted':'\u2705 Tarea eliminada', 'tasks.checklist':'Checklist', 'tasks.addItem':'+ Agregar',
    'tasks.client':'Cliente', 'tasks.status':'Status', 'tasks.personalNoClient':'Personal (sin cliente)', 'tasks.changeStatus':'Cambiar status',
    'tasks.priorityHigh':'Alta', 'tasks.priorityNormal':'Normal', 'tasks.priorityLow':'Baja',
    'tasks.statusOpen':'Abierta', 'tasks.statusInProgress':'En Proceso', 'tasks.statusDone':'Completada',
    'notif.taskAssignedTitle':'Fuiste asignado(a) a una tarea', 'notif.taskAssignedBody':'{name} te asign\u00F3 a la tarea \"{task}\"', 'notif.viewTask':'Ver tarea',
